...
public class ThreadPool {
    ...
    // 线程池维护线程的最大数量
    private static final int MAXINUMPOOLSIZE = Integer.valueOf(Main.applicationContext
            .getBean(PropertieService.class).MAX_POOL_SIZE);
    ...
    private static ThreadPoolExecutor threadPool = new ThreadPoolExecutor(COREPOOLSIZE, MAXINUMPOOLSIZE,
